...
#include <memory>
#include "../../threadDemo/tdicethread.h"
...
struct qt_meta_stringdata_TDiceThread_t {
    QByteArrayData data[5];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TDiceThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TDiceThread_t qt_meta_stringdata_TDiceThread = {
    {
QT_MOC_LITERAL(0, 0, 11), // "TDiceThread"
...
QT_MOC_LITERAL(4, 26, 9) // "diceValue"
    ...
    "TDiceThread\0newValue\0\0seq\0diceValue"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_TDiceThread[] = {
...
void TDiceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TDiceThread::newValue)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TDiceThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_TDiceThread.data,
    qt_meta_data_TDiceThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TDiceThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TDiceThread.stringdata0))
